...
static void help()
{
  fprintf(stderr, "pkt-analyze\n");
  fprintf(stderr, "\tInput packets from stdin and analyze fields.\n\n");
  fprintf(stderr, "EXAMPLE:\n");
  fprintf(stderr, "\t$ pkt-recv -i eth0 | pkt-analyze\n");
  fprintf(stderr, "\t$ cat packet.txt | pkt-analyze\n\n");
